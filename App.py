...
def haversine_distance(p1, p2):
    """Beregner nøyaktig avstand mellom to punkter i meter"""
    R = 6371000 
...
def hent_vaer_detaljer(lat, lon, tid):
    ...
    try:
        ...
        return {
            ...
            "nedbor": neste.get('details', {}).get('precipitation_amount', 0),
            ...
            for i in range(len(alle_punkter) - 1):
                ...
                if akk_meter >= neste_sjekk_meter:
                    ...
                    temp_tabell.append({
                        ...
                        "Værtype": vaer['vaertype'], "Lys": lys_txt, "Nedbør (mm)": vaer['nedbor'],
                        "Temp": f"{vaer['temp']}°C", "Vind (Kast)": f"{vaer['vind']} ({vaer['kast']})",
